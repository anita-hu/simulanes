...
#
# Original source: https://github.com/carla-simulator/carla/blob/0.9.11/PythonAPI/examples/spawn_npc.py
...
class NPCManager(object):
    ...
    def spawn_npc(self):
        ...
        # do a tick to ensure client receives the last transform of the walkers we have just created
        world.tick()
